...
function App() {
  ...
  const EXAMPLE_PROFILE: ProfileProps = {
    ...
    specialisations: {
      items: ["Либерал", "Запой", "Бомжекоп", "Криминалистика", "Экзистенциальные расследования"],
    },
    ...
    body: {
      aboutMeInfo: "Закаленный в боях с самим собой детектив с обостренным чувством справедливости и хронической нехваткой аспирина. Специализируюсь на делах, где граница между преступником и жертвой тоньше лезвия бритвы. Умею находить clues в самых неожиданных местах — от протоколов до дна стакана.",
      experience: [
        {
